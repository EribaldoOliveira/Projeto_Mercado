...
public class Mercado {
	...
	private static void comprarProduto() {
		if(Mercado.produtos.size() > 0) {
			System.out.println("Informe 0 código do produto que deseja comprar: ");
			System.out.println();
		...
		for (Produto p : Mercado.produtos) {
			...
			if(tem) {
				System.out.println("Deseja adicionar outtros produtos no carrinho? ");
